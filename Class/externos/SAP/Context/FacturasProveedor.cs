namespace WebApiCore.Class.externos.SAP.Context
{
    public class FacturasProveedor
    {
        ...
        public partial class properties
        {
            ...
            private string supplierInvoiceField;
            ...
            private DateTime postingDateField;

            private string invoicingPartyField;

            private decimal invoiceGrossAmountField;

            private string documentCurrencyField;

            private string supplierPostingLineItemTextField;
            ...
            public string InvoicingParty
            {
                get
                {
                    return this.invoicingPartyField;
                }
                set
                {
                    this.invoicingPartyField = value;
                }
            }
            ...
            public string SupplierPostingLineItemText
            {
                get
                {
                    return this.supplierPostingLineItemTextField;
                }
                set
                {
                    this.supplierPostingLineItemTextField = value;
                }
            }
        }
    }
